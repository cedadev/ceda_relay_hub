...
data_type=(S1A_.._RAW_	S1B_.._RAW_	S1A_.._SLC_	S1B_.._SLC_	S1A_.._GRDM	S1B_.._GRDM	S1A_.._GRDH	S1B_.._GRDH	S1A_.._GRDF	S1B_.._GRDF	S1A_.._OCN_	S1B_.._OCN_
 S2A_MSIL1C_ S2B_MSIL1C_ S2A_MSIL2A_ S2B_MSIL2A_ S3A_SR_ S3A_OL_ S3A_SL_ S3B_SR_ S3B_OL_ S3B_SL_ S2B_ S2A_ S1B_ S1A_ S3A_.._ S3B_.._ )
...
i=0
j=0
while [ -n "${remote_site[$i]}" ]
  do
  
      for j in `seq 0 $((${#data_type[*]} - 1))`
  				do
