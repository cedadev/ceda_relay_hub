...
hostUrl=https://srh-test1.cems.rl.ac.uk/dhus
# keep account a bit secret
export WGETRC=$(dirname $0)/.cedahubrc
...
do
  ...
  | egrep 'd:Id|d:Name|d:IngestionDate|        <d:Value>|d:ContentLength|</m:properties>' | sed -e 's^</m:properties>^#^' \
