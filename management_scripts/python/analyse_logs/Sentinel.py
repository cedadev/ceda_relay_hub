...
class Sentinel_Product(object):
    ...
    MISSIONS = ['S1A', 'S1B', 'S2A', 'S2B', 'S2C', 'S3A', 'S3B', 'S5P']
    ...
    SENSING_DATE_PARAMS = {'S1A':'17:32', 'S1B':'17:32', 'S2A':{'S2A_OPER_PRD_MSIL1C':'25:40', 'S2A_MSIL1C':'11:26','S2A_MSIL2A':'11:26'},\
                           'S2B':{'S2B_OPER_PRD_MSIL1C':'25:40', 'S2B_MSIL1C':'11:26','S2B_MSIL2A':'11:26', 'S2B_MSIL2A':'11:26'}, \
                           'S2C':{'S2C_OPER_PRD_MSIL1C':'25:40', 'S2C_MSIL1C':'11:26','S2C_MSIL2A':'11:26', 'S2C_MSIL2A':'11:26'}, \
                           'S3A':'16:30', 'S3B':'16:30', 'S5P':'20:35'}
    ...
    PRODUCT_NAME_PARAMS = {'S1A':'0:11', 'S1B':'0:11', 'S2A':{'S2A_OPER_PRD_MSIL1C':'0:19', 'S2A_MSIL1C':'0:10', 'S2A_MSIL2A':'0:10'}, \
                           'S2B':{'S2B_OPER_PRD_MSIL1C':'0:19', 'S2B_MSIL1C':'0:10', 'S2B_MSIL2A':'0:10'}, \
                           'S2C':{'S2C_OPER_PRD_MSIL1C':'0:19', 'S2C_MSIL1C':'0:10', 'S2C_MSIL2A':'0:10'}, \
                           'S3A':'0:11', 'S3B':'0:11', 'S5P':'0:20'}
